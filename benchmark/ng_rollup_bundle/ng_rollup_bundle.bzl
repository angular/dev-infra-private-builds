...
""",
    ...
    "_rollup": attr.label(
        executable = True,
        cfg = "host",
        default = Label("@npm_angular_dev_infra_private//benchmark/ng_rollup_bundle:rollup_with_build_optimizer"),
    ),
    "_rollup_config_tmpl": attr.label(
        default = Label("@npm_angular_dev_infra_private//benchmark/ng_rollup_bundle:rollup.config.js"),
        allow_single_file = True,
    ),
}

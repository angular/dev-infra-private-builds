...
load("@npm_angular_bazel//src:esm5.bzl", "esm5_outputs_aspect", "esm5_root_dir", "flatten_esm5")
...
""",
    ...
    "_rollup": attr.label(
        executable = True,
        cfg = "host",
        default = Label("@npm_dev_infra//benchmark/ng_rollup_bundle:rollup_with_build_optimizer"),
    ),
    "_rollup_config_tmpl": attr.label(
        default = Label("@npm_dev_infra//benchmark/ng_rollup_bundle:rollup.config.js"),
        allow_single_file = True,
    ),
}
...
def ng_rollup_bundle(name, **kwargs):
    ...
    common_terser_args = {
        ...
        "config_file": "@npm_dev_infra//benchmark/ng_rollup_bundle:terser_config.json",
        "sourcemap": False,
    }
    ...
    npm_package_bin(
        ...
        tool = "@npm_dev_infra//benchmark/brotli-cli",
        data = [name + ".min.js"],
        outs = [name + ".min.js.br"],
        args = [

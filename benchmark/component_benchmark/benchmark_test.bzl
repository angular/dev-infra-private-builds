...
def benchmark_test(name, server, tags = [], **kwargs):
    protractor_web_test_suite(
        name = name,
        browsers = ["@npm_dev_infra//benchmark/browsers:chromium"],
        configuration = "@npm_dev_infra//benchmark/component_benchmark:protractor-perf.conf.js",
        on_prepare = "@npm_dev_infra//benchmark/component_benchmark:start-server.js",
        server = server,

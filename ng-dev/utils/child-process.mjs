...
function spawnInteractive(command, args, options = {}) {
    return new Promise((resolve, reject) => {
        ...
        const childProcess = (0, child_process_1.spawn)(command, args, { ...options, shell: true, stdio: 'inherit' });
...
function spawn(command, args, options = {}) {
    return new Promise((resolve, reject) => {
        ...
        (0, console_1.debug)(`Executing command: ${commandText}`);
        const childProcess = (0, child_process_1.spawn)(command, args, { ...options, shell: true, stdio: 'pipe' });
        let logOutput = '';
        let stdout = '';
        let stderr = '';
...
function spawnSync(command, args, options = {}) {
    const commandText = `${command} ${args.join(' ')}`;
    (0, console_1.debug)(`Executing command: ${commandText}`);
    const { status: exitCode, signal, stdout, stderr, } = (0, child_process_1.spawnSync)(command, args, { ...options, encoding: 'utf8', shell: true, stdio: 'pipe' });

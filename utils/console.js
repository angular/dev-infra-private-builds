...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define("@angular/dev-infra-private/utils/console", ["require", "exports", "tslib", "chalk", "fs-extra", "inquirer", "inquirer-autocomplete-prompt", "path", "@angular/dev-infra-private/utils/config"], factory);
    }
    ...
    function captureLogOutputForCommand(argv) {
        ...
        process.on('exit', function (code) {
            ...
            fs_extra_1.writeFileSync(logFilePath, LOGGED_TEXT);
            // For failure codes greater than 1, the new logged lines should be written to a specific log
            // file for the command run failure.
            if (code > 1) {
                fs_extra_1.writeFileSync(path_1.join(config_1.getRepoBaseDir(), ".ng-dev.err-" + now.getTime() + ".log"), LOGGED_TEXT);
            }
        });

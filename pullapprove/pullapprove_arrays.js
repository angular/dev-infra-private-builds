(function (factory) {
    ...
    var PullApproveStringArray = /** @class */ (function (_super) {
        ...
        PullApproveStringArray.prototype.include = function (pattern) {
            return new (PullApproveStringArray.bind.apply(PullApproveStringArray, tslib_1.__spread([void 0], this.filter(function (s) { return utils_1.getOrCreateGlob(pattern).match(s); }))))();
        };
    ...
    var PullApproveGroupArray = /** @class */ (function (_super) {
        ...
        PullApproveGroupArray.prototype.include = function (pattern) {
            return new (PullApproveGroupArray.bind.apply(PullApproveGroupArray, tslib_1.__spread([void 0], this.filter(function (s) { return s.groupName.match(pattern); }))))();
        };
        /** Returns a new array which only includes files that did not match the given pattern. */

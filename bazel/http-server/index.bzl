...
http_server_rule = rule(
    ...
    attrs = {
        ...
        "_server_bin": attr.label(
            default = Label("@npm//@angular/dev-infra-private/bazel/http-server:server_bin"),
        ),
        "_launcher_template": attr.label(
            allow_single_file = True,
            default = Label("@npm//@angular/dev-infra-private/bazel/http-server:launcher_template.sh"),
        ),
    },
)

...
def js_mapping_size_test(
    ...
    all_data = ["@npm//@angular/dev-infra-private/bazel/map-size-tracking", src, source_map, golden_file]
    entry_point = "@npm//@angular/dev-infra-private/bazel/map-size-tracking:index.ts"
